...
const getSystemPrompt = (mood: string) => {
  let str = `You are a creative short story writer. You will use as inspiration the 
words given by the user to create a story with the following mood: ${mood}. Each 
time you respond you will complement the story so far with a development related to the word given by the user. 
...
put between key tags the same word given the user previously. Be as creative as 
